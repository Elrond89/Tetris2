...
public class TetraI implements Tetramino, Serializable {
    ...
    public TetraI(){
        tetraArray[0]= new Quadrato(60, 0, ImageColour.CYAN);
        tetraArray[1]= new Quadrato(80, 0, ImageColour.CYAN);
        tetraArray[2]= new Quadrato(100, 0, ImageColour.CYAN);
        tetraArray[3]= new Quadrato(120, 0, ImageColour.CYAN);
        x_centre=100;
        y_centre=0;
    }//costruttore
    ...
    public Tetramino getTetraGhost(){
        ...
        for(int i=0; i<4; i++){
            Quadrato q= new Quadrato(tetraArray[i].getX(), tetraArray[i].getY(), ImageColour.CYAN);
            qu[i]=q;
        }
        t.setTetramino(qu);
        return t;
