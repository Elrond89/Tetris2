...
public class ChooseGameModePanel extends JPanel {
    ...
    public ChooseGameModePanel(TetrisPanelsController tetrisPanelsController){
        ...
        marathonButton= new TetraButton();
        marathonButton.setActionCommand("marathon");
        ...
        backButton.setActionCommand("backFromGameMode");
