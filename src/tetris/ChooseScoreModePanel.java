 ...
 */
public class ChooseScoreModePanel extends JPanel {
    ...
    public ChooseScoreModePanel(TetrisPanelsController tetrisPanelsController){
    ...
    private void init(){
        backgroundImage= Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/tetris/images/chooseChallengeImages/TetrisFinest.png"));
